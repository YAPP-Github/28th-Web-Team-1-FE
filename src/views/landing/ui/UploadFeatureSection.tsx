  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 pb-10 md:pt-24 md:pb-16">
      ...
      <div className="relative mt-4 flex flex-col items-center overflow-hidden pt-16 pb-16 md:pt-32 md:pb-24">
        ...
        <img src="/landing/upload-arrows.svg" alt="" className="relative mt-2 block h-8 w-56 sm:h-11 sm:w-80 md:h-15 md:w-107" aria-hidden />
        ...
        <Flex align="center" className="relative mt-6 gap-3 md:mt-8 md:gap-4" direction="column">
          ...
          <p className="text-[22px] leading-[1.3] font-bold tracking-tight text-white md:text-[40px]">이력서 자동 생성 완료</p>
        </Flex>
      </div>
    </section>
  )
