      ...
      >
        ...
        <div className="relative h-27 w-65 shrink-0 md:h-40.75 md:w-100">
          <Flex align="center" justify="center" className="h-49 w-44 md:h-75.75 md:w-67.5">
            <div className="mt-4 rotate-[13.21deg] md:mt-8">
          ...
          <Sparkle className="absolute top-8 left-53 size-6.5 text-white md:top-13 md:left-82 md:size-10.25" fill="currentColor" />
          <Sparkle className="absolute top-3 left-61 size-4 text-white md:top-5 md:left-94 md:size-6.25" fill="currentColor" />

          <span className="bg-primary-30 shadow-3 absolute top-19 left-34 rounded-full px-2.5 py-1 text-sm font-semibold whitespace-nowrap text-white md:top-29.5 md:left-53 md:px-3.5 md:py-1.5 md:text-xl">
            90% 매칭
          </span>
        </div>
      </Flex>
