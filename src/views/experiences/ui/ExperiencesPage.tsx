...
const ResumeCtaCard = () => (
  <Link href="/home" className="w-full">
    ...
    >
      ...
      <Button variant="tertiary" size="xs" asChild className="hover:bg-btn-primary-fill group-hover:bg-btn-primary-fill group-hover:text-text-bolder-inverse transition-colors">
        <span>
          이력서 만들기
