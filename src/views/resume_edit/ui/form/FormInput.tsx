 ...
 */
export const FormInput = ({ name, maxLength = 150, ...props }: FormInputProps) => {
  ...
  return (
    <Controller
      ...
      render={({ field }) => <Input {...props} value={typeof field.value === 'string' ? field.value : ''} onChange={field.onChange} onBlur={field.onBlur} maxLength={maxLength} />}
    />
  )
}
