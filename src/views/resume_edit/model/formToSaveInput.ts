 ...
 */
const toSavePayload = (payload: ResumeFormItem['payload']): ResumeSectionItemPayloadInput =>
  payload.coreSkill ? { ...payload, coreSkill: { content: payload.coreSkill.content, isInitialItem: false } } : payload
