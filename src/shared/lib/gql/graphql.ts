...
export type ExperiencesQuery = {
  experiences: {
    cursor: { hasNext: boolean; nextCursor: string | null }
    experiences: Array<{
      experienceId: string
      title: string
      tags: Array<string>
      project: { projectId: string; name: string; role: string | null; period: { startAt: string | null; endAt: string | null } | null } | null
    }>
  }
}
...
export type ProjectExperiencesQuery = {
  experiences: {
    cursor: { hasNext: boolean; nextCursor: string | null }
    experiences: Array<{ experienceId: string; title: string; tags: Array<string>; role: string | null; period: { startAt: string | null; endAt: string | null } | null }>
  }
}
...
export type ExperienceQuery = {
  experience: {
    ...
    contents: { type: ExperienceContentsType; star: { situation: string; task: string; action: string; result: string } | null; free: { content: string } | null }
  } | null
}
...
export type SearchExperiencesQuery = {
  searchExperiences: {
    cursor: { hasNext: boolean; nextCursor: string | null }
    experiences: Array<{ experienceId: string; title: string; tags: Array<string>; project: { projectId: string; name: string } | null }>
  }
}
...
export type MatchedExperiencesQuery = {
  experiences: {
    ...
    experiences: Array<{
      ...
      role: string | null
      period: { startAt: string | null; endAt: string | null } | null
      contents: { type: ExperienceContentsType; free: { content: string } | null; star: { situation: string; task: string; action: string; result: string } | null }
...
export type JdDetailQuery = {
  jd: { companyIntro: string; responsibilities: Array<string>; requiredExperiences: Array<string>; preferredExperiences: Array<string>; hiringProcess: Array<string> } | null
}
...
export type NotionConnectionsQuery = {
  notionConnections: { connections: Array<{ connectionId: string; notionWorkspaceName: string | null; notionWorkspaceIcon: string | null }>; cursor: { hasNext: boolean; nextCursor: string | null } }
}
...
export type NotionPagesQuery = {
  notionPages: { pages: Array<{ pageId: string; title: string; url: string | null; lastEditedTime: string | null }>; cursor: { hasNext: boolean; nextCursor: string | null } }
}
...
export type ProfileQuery = {
  profile: {
    ...
    email: string | null
    phone: string | null
    educations: Array<{ school: string | null; major: string | null; degree: Degree | null; status: EducationStatus | null; period: { startAt: string | null; endAt: string | null } | null }>
    careers: Array<{ company: string | null; position: string | null; period: { startAt: string | null; endAt: string | null } | null }>
    awards: Array<{ title: string | null; organization: string | null; awardedAt: string | null }>
    languageTests: Array<{ testName: string | null; score: string | null; acquiredAt: string | null }>
    certifications: Array<{ name: string | null; issuer: string | null; acquiredAt: string | null }>
    skills: Array<{ name: string | null; level: SkillLevel | null }>
  }
}
...
export type ProjectsQuery = {
  projectList: { cursor: { hasNext: boolean; nextCursor: string | null }; projects: Array<{ projectId: string; name: string; period: { startAt: string | null; endAt: string | null } | null }> }
}
...
export type ResumesQuery = {
  resumes: {
    cursor: { hasNext: boolean; nextCursor: string | null }
    resumes: Array<{ resumeId: string; status: ResumeStatusType; createdAt: string; targetJd: { jdId: string; companyName: string; positionTitle: string; coreCompetencies: Array<string> } | null }>
  }
}
...
export type ResumeEducationFieldsFragment = {
...
export type ResumeQuery = {
  resume: {
    ...
    status: ResumeStatusType
    template: ResumeTemplate
    targetJd: { jdId: string; companyName: string; positionTitle: string } | null
    sections: Array<{
      sectionId: string
      type: ResumeSectionType
      displayText: string
      ...
      items: Array<{
        ...
        visible: boolean
        payload: {
          basicInfo: { name: string | null; email: string | null; phone: string | null; hideContact: boolean } | null
          coreSkill: { content: string | null; isInitialItem: boolean } | null
          career: { companyName: string | null; role: string | null; contents: string | null; period: { startAt: string | null; endAt: string | null } | null } | null
          experience: { name: string | null; role: string | null; contents: string | null; period: { startAt: string | null; endAt: string | null } | null } | null
          education: { schoolName: string | null; major: string | null; degree: string | null; status: string | null; period: { startAt: string | null; endAt: string | null } | null } | null
          award: { name: string | null; organization: string | null; awardedAt: string | null } | null
          language: { examName: string | null; scoreOrGrade: string | null; acquiredAt: string | null } | null
          certificate: { name: string | null; organization: string | null; acquiredAt: string | null } | null
          skill: { name: string | null; level: string | null } | null
        }
      }>
    }>
  }
...
) as unknown as TypedDocumentString<ProjectListItemFragment, unknown>
export const ResumeBasicInfoFieldsFragmentDoc = new TypedDocumentString(
  ...
  hideContact
    ...
    `,
  { fragmentName: 'ResumeBasicInfoFields' }
) as unknown as TypedDocumentString<ResumeBasicInfoFieldsFragment, unknown>
export const ResumeCoreSkillFieldsFragmentDoc = new TypedDocumentString(
  ...
  isInitialItem
    ...
    `,
  { fragmentName: 'ResumeCoreSkillFields' }
) as unknown as TypedDocumentString<ResumeCoreSkillFieldsFragment, unknown>
export const ResumeCareerFieldsFragmentDoc = new TypedDocumentString(
  ...
  period {
    ...
    `,
  { fragmentName: 'ResumeCareerFields' }
) as unknown as TypedDocumentString<ResumeCareerFieldsFragment, unknown>
export const ResumeExperienceFieldsFragmentDoc = new TypedDocumentString(
  ...
  period {
    ...
    `,
  { fragmentName: 'ResumeExperienceFields' }
) as unknown as TypedDocumentString<ResumeExperienceFieldsFragment, unknown>
export const ResumeEducationFieldsFragmentDoc = new TypedDocumentString(
  ...
  period {
    ...
    `,
  { fragmentName: 'ResumeEducationFields' }
) as unknown as TypedDocumentString<ResumeEducationFieldsFragment, unknown>
export const ResumeAwardFieldsFragmentDoc = new TypedDocumentString(
  ...
  awardedAt
    ...
    `,
  { fragmentName: 'ResumeAwardFields' }
) as unknown as TypedDocumentString<ResumeAwardFieldsFragment, unknown>
export const ResumeLanguageFieldsFragmentDoc = new TypedDocumentString(
  ...
  acquiredAt
    ...
    `,
  { fragmentName: 'ResumeLanguageFields' }
) as unknown as TypedDocumentString<ResumeLanguageFieldsFragment, unknown>
export const ResumeCertificateFieldsFragmentDoc = new TypedDocumentString(
  ...
  acquiredAt
    ...
    `,
  { fragmentName: 'ResumeCertificateFields' }
) as unknown as TypedDocumentString<ResumeCertificateFieldsFragment, unknown>
export const ResumeSkillFieldsFragmentDoc = new TypedDocumentString(
  ...
  level
    ...
    `,
  { fragmentName: 'ResumeSkillFields' }
) as unknown as TypedDocumentString<ResumeSkillFieldsFragment, unknown>
